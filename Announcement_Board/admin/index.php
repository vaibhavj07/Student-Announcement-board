<?php
/* This section of code verifies if the admin who is logging in has valid credentials or not*/
  session_start();
  $connection = mysqli_connect("localhost","root","");
  $db = mysqli_select_db($connection,"announcement_center");
/* Compares the admin's id and password entered by the user against the users table*/
...
?>
  <!--This section contains the Html code for the login page of the Admins -->
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Online Announcement Center</title>
    <!-- Bootstrap files -->
    ...
    <section id="login_form">
      <div class="row">
        <div class="col-md-4 m-auto block">
            <!--This section contains the Html code for the login form of the Admin -->
          ...
          <center><a href="../index.php">Student Login</a><center> <!--Navigates to the student login page -->
        </div>
      </div>
    </section>
  </body>
